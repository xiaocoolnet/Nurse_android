package chinanurse.cn.nurse.pnlllist;
...
import chinanurse.cn.nurse.pnlllist.ILoadingLayout.State;

/**
 * 这个类实现了ListView下拉刷新，上加载更多和滑到底部自动加载
 */
public class PullToRefreshListView_delet extends PullToRefreshBase<ListView> implements AbsListView.OnScrollListener {
     ...
     *            context
     */
    public PullToRefreshListView_delet(Context context) {
        this(context, null);
    }
     ...
     *            attrs
     */
    public PullToRefreshListView_delet(Context context, AttributeSet attrs) {
     ...
     *            defStyle
     */
    public PullToRefreshListView_delet(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected SwipeListView createRefreshableView(Context context, AttributeSet attrs) {
        SwipeListView listView = new SwipeListView(context);
        mListView = listView;
