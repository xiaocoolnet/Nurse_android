...
public class EmployDetailsfragment extends Fragment implements View.OnClickListener {
    ...
    private TextView employ_tv_contact_gone,tv_sendjianli,tv_sendjianli_back;
...
//        nurseEmployData = (NurseEmployTalentBean.DataBean) getArguments().getSerializable("recruit");
    ...
    private void initView() {
        ...
        tvCompanyIntro = (TextView) mView.findViewById(R.id.employ_tv_company_intro);
        tvEducation = (TextView) mView.findViewById(R.id.employ_tv_education);
        tvAddress = (TextView) mView.findViewById(R.id.employ_tv_address);
        tvCount = (TextView) mView.findViewById(R.id.employ_tv_count);
        tvWelfare = (TextView) mView.findViewById(R.id.employ_tv_welfare);
        tvDescrip = (TextView) mView.findViewById(R.id.employ_tv_description);
        tvcrite = (TextView) mView.findViewById(R.id.employ_tv_company_time);
        tv_sendjianli = (TextView) mView.findViewById(R.id.tv_sendjianli);
        ...
        tvContact = (TextView) mView.findViewById(R.id.employ_tv_contact);//电话
        tvContact_name = (TextView) mView.findViewById(R.id.employ_tv_contact_name);//姓名称呼
        employ_tv_xinzi = (TextView) mView.findViewById(R.id.employ_tv_xinzi);//薪资
    }
            ...
            case R.id.employ_tv_contact_gone:
                if (user.getUserid() != null&&user.getUserid().length() > 0){
                    if ("2".equals(user.getUsertype())) {
                        Toast.makeText(getActivity(), "您是企业用户，不能查看联系方式", Toast.LENGTH_SHORT).show();
                    }
                }else{
