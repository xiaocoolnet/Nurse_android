...
//        nr_fragment = new Goman_topic_NR_fragment();
        nr_fragment = new Goman_first_nurse_qualification();
        nation_fragment = new Goman_second_nurse_qualification();
        competency_fragment = new Goman_three_nurse_qualification();
...
//            alert.show();
    ...
    protected void onResume() {
        super.onResume();
        StatService.onPageStart(this, "8万道题库");
    }
    ...
    protected void onPause() {
        ...
        StatService.onPageEnd(this, "8万道题库");
    }
    @Override
