...
import chinanurse.cn.nurse.Fragment_Study.example.Eaxm_first_canon;
 ...
 */
public class Example_Canon extends AppCompatActivity implements View.OnClickListener {
    ...
    private Eaxm_first_canon examfirst;
    ...
    public void initView() {
        ...
        examfirst = new Eaxm_first_canon();
        fragments = new Fragment[]{examfirst, examfirst, examfirst};
        Bundle bundle = new Bundle();
        pagename = tv_rn.getText().toString();
        bundle.putString("pagename", pagename);
        examfirst.setArguments(bundle);
        fragmentTransaction = fragmentManager.beginTransaction();
        fragmentTransaction.add(R.id.rela_fragment, examfirst).commit();
...
//                nr_fragment = new Goman_topic_NR_fragment();
            ...
            case R.id.line_nation:
                ...
                examfirst.setArguments(bundlenation);
                //如果transaction  commit（）过  那么我们要重新得到transaction
                fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.add(R.id.rela_fragment, examfirst).commit();
                overridePendingTransition(R.anim.activity_int_left, R.anim.activity_out_top);
            ...
            case R.id.line_competency:
                ...
                examfirst.setArguments(bundleconpetency);
                //如果transaction  commit（）过  那么我们要重新得到transaction
                fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.add(R.id.rela_fragment, examfirst).commit();
                overridePendingTransition(R.anim.activity_int_left, R.anim.activity_out_top);
...
//            alert.show();
    ...
    protected void onResume() {
        super.onResume();
        StatService.onPageStart(this, "考试宝典");
    }
    ...
    protected void onPause() {
        ...
        StatService.onPageEnd(this, "考试宝典");
    }
    @Override
