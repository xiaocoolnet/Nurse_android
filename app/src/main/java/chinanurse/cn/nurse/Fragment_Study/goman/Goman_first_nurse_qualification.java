...
public class Goman_first_nurse_qualification extends Fragment implements View.OnClickListener{
    private View mView;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.goman_simulation_test://模拟考试
                ...
                intent.putExtra("firstpage","护士资格");
    ...
    public void onResume() {
        super.onResume();
        StatService.onPageStart(getActivity(), "8万道题库_护士资格");
    }
    ...
    public void onPause() {
        ...
        StatService.onPageEnd(getActivity(), "8万道题库_护士资格");
    }
}
