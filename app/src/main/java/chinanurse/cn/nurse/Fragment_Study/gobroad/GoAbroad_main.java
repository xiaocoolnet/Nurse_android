 ...
 */
public class GoAbroad_main extends AppCompatActivity implements View.OnClickListener{
    ...
    private Go_Abrode nr_fragment;
    private Go_Abrode_one nation_fragment;
    private Go_Abrode_two competency_fragment;
    ...
    private String pagename,channelid;
    ...
    private void gobroadview() {
        ...
        nr_fragment = new Go_Abrode();
        nation_fragment = new Go_Abrode_one();
        competency_fragment = new Go_Abrode_two();
        ...
        tv_rn.setText("美国RN");
        tv_nation.setText("国际护士证");
        tv_conpetency.setText("新加坡");
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.line_nation:
                ...
                bundlenation.putString("channelid", channelid);
            ...
            case R.id.line_competency:
                ...
                bundleconpetency.putString("channelid", channelid);
...
//            alert.show();
    ...
    protected void onResume() {
        super.onResume();
        StatService.onPageStart(this, "出国考试");
    }
    ...
    protected void onPause() {
        ...
        StatService.onPageEnd(this, "出国考试");
    }
    @Override
