...
public class Clinic_Nurse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clinic__nurse);
        mactivity = this;
...
//        pulllist.doPullRefreshing(true, 500);
    ...
    private void getnewslistother() {
        if (HttpConnect.isConnnected(mactivity)){
            ...
            dialogpgd.show();
            new StudyRequest(Clinic_Nurse.this, handler).getNewsListother(channelid,String.valueOf(page),FIRSTPAGELIST);
        }else{
...
//            alert.show();
    ...
    protected void onResume() {
        super.onResume();
        StatService.onPageStart(this, "临床护理");
    }
    ...
    protected void onPause() {
        ...
        StatService.onPageEnd(this, "临床护理");
    }
    @Override
