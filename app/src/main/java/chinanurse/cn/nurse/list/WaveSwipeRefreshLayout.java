...
package chinanurse.cn.nurse.list;
...
public class WaveSwipeRefreshLayout extends ViewGroup
  ...
  public boolean onPreDraw() {
    ...
    if (mIsManualRefresh) {
      ...
      reInitCircleView();
      mCircleView.setBackgroundColor(Color.TRANSPARENT);//颜色
//      mCircleView.setBackgroundColor(getResources().getColor(R.color.purple));//颜色
