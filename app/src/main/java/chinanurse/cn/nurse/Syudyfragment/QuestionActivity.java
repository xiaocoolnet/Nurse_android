 ...
 */
public class QuestionActivity extends Activity implements View.OnClickListener, ViewFlipperSelfe.OnViewFlipperListener {
...
//                            answer_list_adapter.notifyDataSetChanged();
                            ...
                            Toast.makeText(QuestionActivity.this, R.string.net_erroy, Toast.LENGTH_SHORT).show();
                        }
