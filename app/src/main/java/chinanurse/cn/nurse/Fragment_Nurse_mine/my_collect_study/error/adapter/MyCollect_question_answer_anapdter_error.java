 ...
 */
public class MyCollect_question_answer_anapdter_error extends BaseAdapter{
    private Activity mActivity;
    private List<MineStudt_question_error_Bean.DataBean> listbean;
    ...
    public MyCollect_question_answer_anapdter_error(Activity mActivity, List<MineStudt_question_error_Bean.DataBean> listbean, int currentNum) {
