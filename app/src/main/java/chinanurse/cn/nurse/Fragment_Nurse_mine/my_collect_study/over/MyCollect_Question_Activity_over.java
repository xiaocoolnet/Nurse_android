...
import chinanurse.cn.nurse.Fragment_Nurse_mine.my_collect_study.over.adapter.MyCollectQuestion_Adapter_over;
                    ...
                    if (msg.obj != null) {
                        ...
                        try {
                            ...
                            if ("success".equals(status)) {
                                ...
                                Toast.makeText(MyCollect_Question_Activity_over.this, R.string.question_collect_succcess, Toast.LENGTH_SHORT).show();
...
//                                collectTag.setBackgroundResource(R.mipmap.btn_collet);
                                Toast.makeText(MyCollect_Question_Activity_over.this, R.string.question_cancel_collect, Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                            ...
                            if ("success".equals(obj.optString("status"))) {
                                if("had".equals(obj.optString("data"))){
                                    if (HttpConnect.isConnnected(MyCollect_Question_Activity_over.this)) {
                                        new StudyRequest(MyCollect_Question_Activity_over.this, collecthandler).DELLCOLLEXT(user.getUserid(), listdata.get(ViewPosition).getQuestionid(),
                                                "2", CANCELCOLLECT);
//
                                    } else {
                                        Toast.makeText(MyCollect_Question_Activity_over.this, R.string.net_erroy, Toast.LENGTH_SHORT).show();
                                    }
                                }
                                ...
                                if("no".equals(obj.optString("data"))){
                                    ...
                                    if (HttpConnect.isConnnected(MyCollect_Question_Activity_over.this)) {
                                        ...
                                        new StudyRequest(MyCollect_Question_Activity_over.this, collecthandler).COLLEXT(user.getUserid(), listdata.get(ViewPosition).getQuestionid(), "2",
...
//                    answerlistbean_over.add(dailydata);
                    ...
                    pagerAdapter = new MyCollectQuestion_Adapter_over(
                            MyCollect_Question_Activity_over.this, viewItems,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intent = getIntent();
        //获取当前题目
        dailydata = (MineStudt_question_over_Bean.DataBean.QuestionBean) intent.getSerializableExtra("collquestion");
        //获取总列表
