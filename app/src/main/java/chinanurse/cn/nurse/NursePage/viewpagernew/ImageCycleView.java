package chinanurse.cn.nurse.NursePage.viewpagernew;
...
public class ImageCycleView extends LinearLayout {
	...
	public ImageCycleView(Context context, AttributeSet attrs) {
		...
		LayoutInflater.from(context).inflate(R.layout.firstpagenew, this);
	...
	public void setImageResources(ArrayList<String> imageUrlList, ArrayList<String> imageNameList,ImageCycleViewListener imageCycleViewListener) {
		...
		for (int i = 0; i < imageCount; i++) {
			...
			if (i == 0) {
//				mImageViews[i].setBackgroundResource(R.drawable.banner_dian_focus);bt
			} else {
//				mImageViews[i].setBackgroundResource(R.drawable.banner_dian_blur);bt
			}
	...
	private final class GuidePageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int index) {
			...
			mImageIndex = index;
			// 设置图片滚动指示器背
//			mImageViews[index].setBackgroundResource(R.drawable.banner_dian_focus);bt
