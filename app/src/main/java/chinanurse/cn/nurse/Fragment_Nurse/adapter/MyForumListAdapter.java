...
public class MyForumListAdapter extends BaseAdapter {
    private String TAG = "MyForumListAdapter";
    ...
    public MyForumListAdapter(Activity activity, ArrayList<ForumDataBean> forumList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mactivity).inflate(
                    R.layout.item_my_forum_list, null);
        ...
        viewHolder.tv_community_into.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentCommunityDetails.putExtra("from", "MyForumListAdapter");
