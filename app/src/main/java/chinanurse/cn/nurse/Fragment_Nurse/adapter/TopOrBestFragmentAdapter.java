...
public class TopOrBestFragmentAdapter extends BaseAdapter {
    private String TAG = "TopOrBestFragmentAdapter";
    ...
    public TopOrBestFragmentAdapter(Context mContext, ArrayList<ForumDataBean> forumList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.item_top_or_best_fragment, null);
        ...
        viewHolder.iv_head.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentHomePage.putExtra("from", "TopOrBestActivity");
