...
public class SearchForumAdapter extends BaseAdapter {
    private String TAG = "SearchForumAdapter";
    ...
    public SearchForumAdapter(Context mContext, ArrayList<ForumDataBean> forumList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.item_search_forum, null);
        ...
        viewHolder.iv_head.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentHomePage.putExtra("from","SearchForumAdapter");
        ...
        viewHolder.tv_community_into.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentCommunityDetails.putExtra("from", "SearchForumAdapter");
