...
/**
 * Created by zhuchongkun on 2016/12/25.
 */

public class FollowForumListAdapter extends BaseAdapter {
    ...
    public FollowForumListAdapter(Activity activity, ArrayList<ForumDataBean> forumList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mactivity).inflate(
                    R.layout.item_follow_forum_list, null);
        ...
        viewHolder.iv_head.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentHomePage.putExtra("from","FollowForumListAdapter");
        ...
        viewHolder.tv_community_into.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentCommunityDetails.putExtra("from", "FollowForumListAdapter");
