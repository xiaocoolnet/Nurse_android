 ...
 *
 */
package chinanurse.cn.nurse.Fragment_Nurse.view.tag;
...
public class TagListView extends FlowLayout implements OnClickListener {
    ...
    private void inflateTagView(final Tag t, boolean b) {
        ...
        if (t.getTitle().equals(AppApplication.TagName)) {
//			if (mTagViewTextColorResId <= 0) {
            int c = getResources().getColor(R.color.whilte);
...
//            if (mTagViewBackgroundResId <= 0) {
            mTagViewBackgroundResId = R.drawable.tag_bg_defult;
            localTagView.setBackgroundResource(mTagViewBackgroundResId);
//			}
        }
    ...
    public void isSelected(boolean b, Tag tag) {
        if (b) {
            TextView v = (TextView) getViewByTag(tag);
            v.setBackgroundResource(R.drawable.tag_bg);
            v.setTextColor(getResources().getColor(R.color.whilte));
        } else {
            TextView v = (TextView) getViewByTag(tag);
            v.setBackgroundResource(R.drawable.tag_bg_defult);
            v.setTextColor(getResources().getColor(R.color.purple));
        }
    }
