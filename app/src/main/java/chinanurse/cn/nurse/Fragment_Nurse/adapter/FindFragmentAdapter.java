...
public class FindFragmentAdapter extends BaseAdapter {
    ...
    public FindFragmentAdapter(Activity activity, ArrayList<ForumDataBean> forumList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mactivity).inflate(
                    R.layout.item_find_fragment, null);
            viewHolder.iv_head = (RoudImage) convertView.findViewById(R.id.iv_item_find_fragment_head);
            viewHolder.iv_authentication = (ImageView) convertView.findViewById(R.id.iv_item_find_fragment_authentication);
            viewHolder.tv_name = (TextView) convertView.findViewById(R.id.tv_item_find_fragment_name);
            viewHolder.tv_post = (TextView) convertView.findViewById(R.id.tv_item_find_fragment_post);
            viewHolder.tv_time = (TextView) convertView.findViewById(R.id.tv_item_find_fragment_time);
            viewHolder.tv_grade = (TextView) convertView.findViewById(R.id.tv_item_find_fragment_grade);
        ...
        viewHolder.tv_comment.setText(forumBean.getCommentsCount());
        ...
        viewHolder.iv_head.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentHomePage.putExtra("from","FindFragmentAdapter");
        ...
        viewHolder.tv_community_into.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intentCommunityDetails.putExtra("from","FindFragmentAdapter");
