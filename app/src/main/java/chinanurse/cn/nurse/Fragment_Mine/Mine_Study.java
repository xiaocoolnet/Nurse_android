...
import chinanurse.cn.nurse.Fragment_Mine.my_collect_study.Mine_study_collect;
import chinanurse.cn.nurse.HttpConn.HttpConnect;
import chinanurse.cn.nurse.HttpConn.request.StudyRequest;
import chinanurse.cn.nurse.MinePage.ChartView;
import chinanurse.cn.nurse.Fragment_Mine.my_collect_study.Question_Collect;
import chinanurse.cn.nurse.Fragment_Mine.my_collect_study.Question_Error;
import chinanurse.cn.nurse.Fragment_Mine.my_collect_study.Question_Over;
...
//        xlabel = new String[]{"7-11", "7-12", "7-13", "7-14", "7-15", "7-16", "7-17"};
    ...
    protected void onResume() {
        super.onResume();
        StatService.onPageStart(this, "我的学习");
        inidata();
    }
...
//        alert.show();
    ...
    protected void onPause() {
        ...
        StatService.onPageEnd(this, "我的学习");
    }
}
