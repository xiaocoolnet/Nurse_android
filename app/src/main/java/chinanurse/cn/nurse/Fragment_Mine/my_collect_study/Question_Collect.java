...
import chinanurse.cn.nurse.Fragment_Mine.mine_collext.adapter.Mine_Collect_Second_Adapter;
...
//        pulllist.doPullRefreshing(true, 500);
    ...
    public void onResume() {
        super.onResume();
        StatService.onPageStart(this, "Question_Collect");
        Log.i("onResume", "---------->onResume");
        StatService.onPageStart(this, "我的学习——试题收藏");
        fansfragment();
    }
    ...
    public void onPause() {
        ...
        StatService.onPageEnd(this, "我的学习——试题收藏");
    }
