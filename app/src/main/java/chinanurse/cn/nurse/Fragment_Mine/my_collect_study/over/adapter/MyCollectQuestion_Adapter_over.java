...
import chinanurse.cn.nurse.Fragment_Mine.my_collect_study.over.MyCollect_Question_Activity_over;
 ...
 * 我的收藏---试题适配器
 */
public class MyCollectQuestion_Adapter_over extends PagerAdapter implements OnClickListener {
    ...
    public MyCollectQuestion_Adapter_over(MyCollect_Question_Activity_over context, List<View> viewItems, List<MineStudt_question_over_Bean.DataBean.QuestionBean> dataItems, String questionType, String questionNum, int mposition) {
        mContext = context;
...
//            }else{
                holder.question_title.setText(answerItems.get(position).getPost_title().toString());
//            }
            holder.adapter = new MyCollect_question_answer_anapdter_over(mContext, answerItems, position);
...
*/
    ...
    public class ViewHolder {
        ...
        private TextView present_topic, question_title, question_score,question_test,question_option,tv_answer_list;
