...
import chinanurse.cn.nurse.Fragment_Mine.my_collect_study.over.FirstFragment_Over;
import chinanurse.cn.nurse.Fragment_Mine.my_collect_study.over.SecondFragment_Over;
...
//            alert.show();
    ...
    protected void onResume() {
        super.onResume();
        StatService.onPageStart(this, "我的学习——我做过的题");
    }
    ...
    protected void onPause() {
        ...
        StatService.onPageEnd(this, "我的学习——我做过的题");
    }
}
