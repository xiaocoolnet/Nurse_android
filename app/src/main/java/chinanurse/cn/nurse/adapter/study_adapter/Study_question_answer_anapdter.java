...
public class Study_question_answer_anapdter extends BaseAdapter{
    ...
    private List<Answer_option_Bean.DataBean> listbean;
    ...
    public Study_question_answer_anapdter(Activity mActivity, List<Answer_option_Bean.DataBean> listbean,int currentNum) {
