 ...
 * 新闻界面列表详情
 */
public class News_WebView_url extends Activity implements View.OnClickListener {
    ...
    private Pop_EditText_url popedittext;
...
//    private static final int ISREFRESH = 2;
    private String title, time, read, source, webId, webview, new_webview, webtitleId,result,choicetype;
    private News_list_type.DataBean fndData;
    private UserBean user;
    private String pagertype, description, pageid;
...
//    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //初始化intent，提取其中传递的值
        intent = getIntent();
        fndData = (News_list_type.DataBean) intent.getSerializableExtra("fndinfo");
        ...
        popedittext = new Pop_EditText_url(News_WebView_url.this);
        //点击收藏
        ...
        if (fndData != null) {
            ...
            web_time.setText(fndData.getPost_date().toString().substring(0, 10) + "");//设置文章时间
