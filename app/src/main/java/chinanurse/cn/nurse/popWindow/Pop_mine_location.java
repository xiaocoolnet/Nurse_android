 ...
 */
public class Pop_mine_location implements PopupWindow.OnDismissListener, View.OnClickListener, OnWheelChangedListener {
...
//	protected String mCurrentZipCode ="";
    ...
    public Pop_mine_location(Myinfo mActivity) {
        ...
        switch (v.getId()) {
            ...
            case R.id.mine_pop_sure:
                ...
                if (HttpConnect.isConnnected(mactivity)) {
                    new StudyRequest(mactivity, handler).updateUserAddress(user.getUserid(), et_content, UPDATEADDRESS);
                } else {
                    Toast.makeText(mactivity, R.string.net_erroy, Toast.LENGTH_SHORT).show();
                }
                mactivity.getPersoanl();
//                textviewlala.setText(mCurrentProviceName + "" + mCurrentCityName + "" + mCurrentDistrictName);
                break;
        }
    }
