 ...
 */
public class Pop_EditText_collect implements PopupWindow.OnDismissListener, View.OnClickListener,View.OnFocusChangeListener{
    private static final int SENDCOMMENT = 1;
    private News_WebView_collect mactivity;
...
//                                "score": "2","event": "评论","create_time": 1473411782,"userid": "600"
    ...
    public Pop_EditText_collect(News_WebView_collect mactivity) {
    ...
    public void onDismiss() {
        if (!"".equals(pop_et_choice.getText().toString())&&pop_et_choice.getText().toString()!=null){
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.pop_bt_send_choice:
                pop_bt_send_choice.setPressed(true);
