 ...
 */
public class Pop_position_location implements PopupWindow.OnDismissListener, View.OnClickListener, OnWheelChangedListener {

    private static final int UPDATEADDRESS = 1;
    private Add_EmployTalent_Fragment mactivity;
...
//	protected String mCurrentZipCode ="";
    ...
    public Pop_position_location(Add_EmployTalent_Fragment mActivity) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.mine_pop_sure:
                ...
                textviewcity.setText(mCurrentProviceName);
