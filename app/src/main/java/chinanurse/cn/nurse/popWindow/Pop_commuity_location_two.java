 ...
 */
public class Pop_commuity_location_two implements PopupWindow.OnDismissListener, View.OnClickListener, OnWheelChangedListener {

    private static final int UPDATEADDRESS = 1;
    private Add_EmployWork_Fragment mactivity;
    ...
    private TextView twoviewshi,twoviewqu;
...
//	protected String mCurrentZipCode ="";
    ...
    public Pop_commuity_location_two(Add_EmployWork_Fragment mActivity) {
...
//        mactivity.findViewById(R.id.myinfo_righttext_text).setT
        ...
        twoviewshi = (TextView) rootView.findViewById(R.id.shi_spinner_02);
//        twoviewqu = (TextView) rootView.findViewById(R.id.qu_spinner_02);
...
//                et_content = mCurrentProviceName + mCurrentCityName + mCurrentDistrictName;
                et_content = mCurrentProviceName +"-"+ mCurrentCityName;
                twoviewshi.setText(et_content);
//                twoviewqu.setText(mCurrentCityName);
                dissmiss();
                break;
        }
    }
