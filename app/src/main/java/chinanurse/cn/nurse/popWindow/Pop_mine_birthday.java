 ...
 */
public class Pop_mine_birthday implements PopupWindow.OnDismissListener, View.OnClickListener, OnWheelChangedListener {
...
//	protected String mCurrentDistrictName ="";
                        ...
                        try {
                            ...
                            if (status.equals("success")) {
                                ...
                                if (jsonObject.getString("score") != null &&jsonObject.getString("score").length() > 0){
                                    ...
                                    final Dialog dialog = new android.support.v7.app.AlertDialog.Builder(mactivity).create();
                                    dialog.show();
    ...
    public Pop_mine_birthday(Myinfo mActivity) {
...
//        mactivity.findViewById(R.id.myinfo_righttext_text).setT
        ...
        textviewlala = (TextView) rootView.findViewById(R.id.myinfo_righttext_text);
        ...
        switch (v.getId()) {
            ...
            case R.id.mine_pop_sure:
                ...
                if (HttpConnect.isConnnected(mactivity)) {
                    new StudyRequest(mactivity, handler).updateUserBirthday(user.getUserid(), et_content, UPDATEBIRTHDAY);
                } else {
                    Toast.makeText(mactivity, R.string.net_erroy, Toast.LENGTH_SHORT).show();
                }
                popupWindow.dismiss();
                mactivity.getPersoanl();
//                textviewlala.setText(mYear + "" + mCurrentCityName + "" + mCurrentDistrictName);
                break;
        }
    }
