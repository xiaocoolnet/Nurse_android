...
//                indicator.setGravity(Gravity.RIGHT|Gravity.BOTTOM);
            }else{
    ...
    public void setImages(Object[] imagesUrl,String isopen) {
        isopen = isopen;
        setImageArray(imagesUrl, null,isopen);
    }
    ...
    private void setImageArray(Object[] imagesUrl, OnLoadImageListener imageListener, String isopen) {
